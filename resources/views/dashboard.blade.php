                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                ...
                                <h3 class="fw-extrabold mb-2">200</h3>
                            </div>
                            <div class="small d-flex mt-1">                               
                                <!-- @if($diff_riders > 0)
                    ...
                    <div class="row d-block d-xl-flex align-items-center">
                        <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            ...
                            <div class="d-sm-none">
                                ...
                                <h3 class="mb-1">$ 111</h3>
                            </div>
                        </div>
                        <div class="col-12 col-xl-7 px-xl-0">
                            <div class="d-none d-sm-block">
                                <h2 class="h6 text-gray-400 mb-0"> Monthly Earning</h2>
                                <h3 class="fw-extrabold mb-2">$111</h3>
                            </div>
                            <div class="small d-flex mt-1">                               
                        ...
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    ...
                                    <div class="small fw-bold text-gray-500"><span>11 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-info" role="progressbar" aria-valuenow="11" aria-valuemin="0" aria-valuemax="100" style="width: 11%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    ...
                                    <div class="small fw-bold text-gray-500"><span>123 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-success" role="progressbar" aria-valuenow="123" aria-valuemin="0" aria-valuemax="100" style="width: 123%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    ...
                                    <div class="small fw-bold text-gray-500"><span>15 %</span></div>
                                </div>
                                <div class="progress mb-0">
...
<script>
    var markers = {};
    var map;
    // var drivers = {!! json_encode($driver_locations) !!};
    var drivers = []
