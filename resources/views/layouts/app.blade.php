<x-layouts.base>
    ...
    @if(in_array(request()->route()->getName(), ['dashboard', 'users', 'usercreate', 'userdetails', 'useredit',   'profile', 'drivers', 'drivercreate', 'driverdetails', 'driveredit', 'earning', 'riders', 'rideredit', 'ridercreate', 'riderequest', 'riderequestcreate', 'riderequestdetails', 'driverratings', 'driverratingdetails', 'riderratings', 'riderratingdetails', 'feedback', 'feedbackdetails', 'profile-example',  'bootstrap-tables', 'transactions',
