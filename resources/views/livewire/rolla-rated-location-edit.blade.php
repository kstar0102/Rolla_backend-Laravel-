<div>
    <title>Edit Rolla-Rated Location</title>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Edit Rolla-Rated Location</h2>
        </div>
    </div>
                ...
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <div wire:ignore id="map" style="width: 100%; height: 400px; border-radius: 8px; border: 1px solid #ddd;"></div>
...
<script>
// Store map instance globally to prevent re-initialization
...
function initializeMap() {
    ...
    var initialLat = @this.get('latitude') || 37.7749;
    var initialLng = @this.get('longitude') || -122.4194;
    ...
    // Add geocoder to map
    mapInstance.addControl(mapGeocoder);
    ...
    function setLocation(lat, lng, address = null) {
        ...
        // Update display
        var latDisplay = document.getElementById('latitude-display');
        var lngDisplay = document.getElementById('longitude-display');
        var coordsDisplay = document.getElementById('coordinates-display');
        
        if (latDisplay) latDisplay.value = lat.toFixed(8);
        if (lngDisplay) lngDisplay.value = lng.toFixed(8);
...
// Re-initialize map after Livewire updates (if needed)
document.addEventListener('livewire:load', function() {
    initializeMap();
});

document.addEventListener('livewire:update', function() {
    // Map should persist due to wire:ignore, but ensure it's initialized
